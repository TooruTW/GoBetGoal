...
// Type definitions for Intl.Segmenter (not yet in all TypeScript versions)
...
interface IntlSegmenter {
  segment(input: string): Iterable<IntlSegmentData>;
}
...
// Type assertion for Intl.Segmenter availability
...
export interface RotatingTextProps
  ...
  animateProps?: boolean | VariantLabels | TargetAndTransition;
  ...
  (
    {
      ...
      animate: animateProps = { y: 0, opacity: 1 },
      ...
      if (typeof Intl !== "undefined" && IntlWithSegmenter.Segmenter) {
        try {
          ...
          return Array.from(
            ...
            (segment: IntlSegmentData) => segment.segment
          );
        } catch (error) {

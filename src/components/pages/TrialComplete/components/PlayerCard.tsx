...
export default function PlayerCard() {
  return (
    <div className="relative h-20 flex items-end">
      ...
      <div className="absolute bottom-3 -left-2.5 w-13 aspect-square bg-schema-primary" style={{clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)"}}>
        <span className="bg-schema-surface-container-high size-full flex items-center justify-center text-h4 scale-95" style={{clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)"}}>1</span>
      </div>
      <ul className="grid grid-cols-9 gap-2 bg-transparent relative z-10 h-full">
        ...
        <li className="col-span-1 flex items-center justify-center">
          <img src={monsterDefault} alt="playerImage" className="w-full scale-150" />
        </li>
        <li className="col-span-2 text-h4 flex items-center justify-center translate-y-1/5">name</li>

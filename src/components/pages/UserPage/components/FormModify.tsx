...
import { useAuthSuccess } from "@/components/pages/Authentication/components/useAuthSuccess";
import PasswordInput from "@/components/pages/Authentication/components/PasswordInput";
import EmailInput from "@/components/pages/Authentication/components/EmailInput";
...
export default function RegisterForm({
  ...
  return (
    <form
      ...
      className="flex-col flex justify-start w-full max-w-110 items-start gap-6 text-white"
    >
      {/* Email */}
      <EmailInput
